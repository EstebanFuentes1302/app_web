<?php
    class FrmMenuUsuario
    {
        public function frmMenuUsuarioShow(){
            ?>
                <!doctype html>
                <html>
                <head>
                    ...
                    <div class="container-fluid">
                        <div class="row flex-nowrap">
                            ...
                            <div class="col-auto col-md-10 min-vh-100 justify-content-center m-5">
                                <p class="h1 text-center mb-3">Gestión de Usuarios</p>
                                <div class="d-grid gap-2 col-6 mx-auto">
                                    <a class="btn btn-primary mb-3" href="../controlador/CtrlShowRegistrarUsuario.php">Registrar Usuario</a>
                                    <a class="btn btn-primary mb-3" href="../controlador/CtrlShowModificarUsuario.php">Modificar Usuario</a>
                                    <a class="btn btn-primary mb-3" href="../controlador/CtrlShowEliminarUsuario.php">Eliminar Usuario</a>
                                    <a class="btn btn-primary mb-3" href="../controlador/CtrlShowVerUsuarios.php">Registro de Usuarios</a>
                                </div>
                            </div>
                        </div>
                    </div>

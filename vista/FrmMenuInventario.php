<?php
    class FrmMenuInventario
    {
        public function frmMenuInventarioShow(){
        ?>
            <!doctype html>
            <html>
            <head>
                    ...
                    <div class="container-fluid">
                        <div class="row flex-nowrap">
                            ...
                            <div class="col-auto col-md-10 min-vh-100 justify-content-center m-5">
                                <p class="h1 text-center mb-3">Gestión de Inventario</p>
                                <div class="d-grid gap-2 col-6 mx-auto">
                                    <a class="btn btn-primary btn-lg mb-3" href="../controlador/CtrlShowIngresarArticulo.php">Ingresar Artículo</a>
                                    <a class="btn btn-primary btn-lg mb-3" href="../controlador/CtrlShowRetirarArticulo.php">Retirar Artículo</a>
                                </div>
                            </div>
                        </div>
                    </div>

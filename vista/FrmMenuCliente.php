<?php
    class FrmMenuCliente{
        public function frmMenuClienteShow(){
        ?>
            <!doctype html>
            <html>
            <head>
            ...
            <div class="container-fluid">
                    ...
                    <div class="bg-dark col-auto col-md-2 min-vh-100">
                            ...
                            <div class="col-auto col-md-10 min-vh-100 justify-content-center m-5">
                                <p class="h1 text-center mb-3">Gestión de Clientes</p>
                                <div class="d-grid gap-2 col-6 mx-auto">
                                    <a class="btn btn-primary btn-lg mb-3" href="../controlador/CtrlShowRegistrarCliente.php">Registrar Cliente</a>
                                    <a class="btn btn-primary btn-lg mb-3" href="../controlador/CtrlShowModificarCliente.php">Modificar Cliente</a>
                                    <a class="btn btn-primary btn-lg mb-3" href="../controlador/CtrlShowVerClientes.php">Registro de Clientes</a>
                                </div>
                            </div>
                        </div>
                    </div>

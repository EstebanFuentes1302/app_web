<?php
    class FrmEliminarUsuario
    {
        public function frmEliminarUsuarioShow(){
            ?>
            <!doctype html>
            <html>
            <head>
            ...
            <body>
                    ...
                    <div class="container-fluid">
                        <div class="row flex-nowrap">
                            ...
                            <div class="col-auto col-md-10 min-vh-100 justify-content-center m-3">
                                <h1 class="h1 text-center">Eliminar Usuario</h1>
                                <form id=formBuscarUsuario method="post">
                                    <div class="div-buscar">
                                        <p class="fs-5">Buscar Código</p>
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <input class="form-control" name="txtCodigoBuscar" type="text" id="txtCodigoBuscar" placeholder="Código de Usuario">
                                            </div>
                                            <button class="btn border ms-2" type="button" name="btnBuscar" id="btnBuscar" onclick="buscarUsuario()">
                                                <img class="icon-buscar" src="../img/icons/lupa.png" style="height: 20px;">
                                            </button>
                                            <button type="button" class="btn border ms-2" name="btnVerUsuarios" id="btnVerUsuarios" title="Ver Usuarios" onclick="verUsuarios()">
                                                <img src="../img/icons/tabla.png" style="height: 20px;"> Ver Usuarios
                                            </button>
                                        </div>
                                        <p class="text-danger d-none" id="txtErrorCodigo">El código de usuario debe ser un número</p>
                                    </div>
                                </form>
                                <form id="formEliminarUsuario">
                                    <div id="divEliminarUsuario" class="mt-3">
                ...
                <form id="formEliminarUsuario">
                    <div id="divEliminarUsuario" class="div-Form"> 
                    </div>
                </form>
                ...
                <script src="../js/validarDatosFormEliminarUsuario.js"></script>
            </body>
            </html>
        <?php
        }

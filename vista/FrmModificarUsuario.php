<?php
    ...
    {
        public function frmModificarUsuarioShow(){
            ?>
            <!doctype html>
            <html>
            <head>
            ...
            <body>
                    ...
                    <div class="container-fluid">
                        <div class="row flex-nowrap">
                            ...
                            <div class="col-auto col-md-10 min-vh-100 justify-content-center m-3">
                                <h1 class="h1 text-center">Modificar Usuario</h1>
                                ...
                                <form id="formModificarUsuario">
                                    <div id="divModificarUsuario" class="mt-3">
                ...
                <form id="formModificarUsuario">
                    <div id="divModificarUsuario" class="div-Form"> 
                    </div>
                </form>
                ...
                <script src="../js/validarDatosFormModificarUsuario.js"></script>
            </body>
            </html>
        <?php
        }
